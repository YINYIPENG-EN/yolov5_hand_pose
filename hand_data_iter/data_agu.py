...
def hand_alignment_aug_fun(imgn,eye_left_n, eye_right_n, facial_landmarks_n = None, angle = None,desiredLeftEye=(0.34, 0.42),desiredFaceWidth=160, desiredFaceHeight=None,draw_flag = False):
